...
| [Phase 3 — 완전 자동 레이아웃](docs/phases/03-full-auto-layout.md) | 🟨 진행 중 | 2026-07-18 | | 1~2단계(패널클론/그리디배치/줌, 이벤트소싱) 완료, 3단계(말풍선+Konva) 착수 전 |
...
- [ ] Phase 3 2단계(이벤트 소싱 백엔드, `apps/server` + SQLite) 착수(`docs/phases/03-full-auto-layout.md`)
- [ ] 2단계 착수 전 확인: Phase 2의 `PanelCanvas`/`AvatarSprite`(아바타 1개가 body-cam 전체를 채운다고 가정)가 1단계에서 만든 다중 body 배치(`layoutBodies`)와 맞물릴 때 렌더링 쪽 수정이 필요한지 검토
